...
public class ProfileUser {
    ...
    @Column(name = "GITHUB_AGREE_YN")
    private String githubAgreeYn;
    ...
    public String getGithubAgreeYn() {
        return githubAgreeYn;
    }

    public void setGithubAgreeYn(String githubAgreeYn) {
        this.githubAgreeYn = githubAgreeYn;
    }
